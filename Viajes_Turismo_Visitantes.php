...
// Obtener el ID del usuario si está registrado
...
if ($usuarioRegistrado) {
    ...
    // Si no está registrado, obtenemos solo los comentarios permitidos
    $stmt = $conn->prepare("SELECT tema, comentario, created_at FROM comentarios WHERE tema IN ($temasPermitidosStr) ORDER BY created_at DESC LIMIT 5");
}
$stmt->execute();
