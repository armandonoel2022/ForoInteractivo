...
<head>
    ...
    <title>Ciencias Ocultas y Misterios</title>
...
<body>
    ...
    <div class="forum-content">
        <h2>Ciencias Ocultas y Misterios</h2>
        ...
        <section class="main-content">
            ...
            <div class="comentarios">
                ...
                $sql = "SELECT tema, comentario, created_at FROM comentarios WHERE tema='Ciencias Ocultas y Misterios' ORDER BY created_at DESC LIMIT 5";
