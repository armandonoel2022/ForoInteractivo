<?php
// Política_y_Sociedad_Registrados_Comentarios.php
session_start();
...
// Filtrar los comentarios de la sección de política y sociedad
$temasPermitidos = ['Actualidad_politica', 'Derechos_humanos', 'Politicas_Sociales', 'Relaciones_internacionales'];
...
<head>
    ...
    <title>Política y Sociedad - Comentarios</title>
...
<body>
    ...
    <div class="forum-content">
        <h2>Política y Sociedad - Comentarios</h2>
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        <option value="Actualidad_politica">Actualidad política</option>
                        <option value="Derechos_humanos">Derechos humanos</option>
                        <option value="Politicas_Sociales">Políticas Sociales</option>
