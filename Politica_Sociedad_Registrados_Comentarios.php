        ...
        <div class="content-wrapper">
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <option value="Lenguajes">Actualidad política</option>
                    <option value="DesarrolloWeb">Derechos humanos</option>
                    <option value="DesarrolloApps">Políticas Sociales</option>
                    <option value="ProyectosOpenSource">Relaciones internacionales</option>
                </select><br><br>
