<?php
// Viajes_y_Turismo_Registrados_Comentarios.php
session_start();
...
// Filtrar los comentarios de la sección de viajes y turismo
$temasPermitidos = ['Destinos_turisticos', 'Consejos_viajes', 'Experiencias_viajes', 'Fotografia_viajes'];
...
<head>
    ...
    <title>Viajes y Turismo - Comentarios</title>
...
<body>
    ...
    <div class="forum-content">
        <h2>Viajes y Turismo - Comentarios</h2>
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        <option value="Destinos_turisticos">Destinos turísticos</option>
                        <option value="Consejos_viajes">Consejos de viaje</option>
                        <option value="Experiencias_viajes">Experiencias de viaje</option>
                        <option value="Fotografia_viajes">Fotografía de viajes</option>
                    </select><br><br>
