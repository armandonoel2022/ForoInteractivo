<?php
// Viajes_Turismo_Registrados_Comentarios.php
session_start();
        ...
        <aside class="sidebar">
            ...
            <form action="guardar_comentario.php" method="POST">
                ...
                <select id="tema" name="tema">
                    <option value="Destinos turísticos">Destinos turísticos</option>
                    <option value="Consejos de viaje">Consejos de viaje</option>
                    <option value="Experiencias de viaje">Experiencias de viaje</option>
                    <option value="Fotografía de viajes">Fotografía de viajes</option>
                </select><br><br>
