        ...
        <div class="content-wrapper">
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <option value="Lenguajes">Tendencias de moda</option>
                    <option value="DesarrolloWeb">Cuidado de la piel</option>
                    <option value="DesarrolloApps">Estilismo y maquillaje</option>
                    <option value="ProyectosOpenSource">Modo sostenible</option>
                </select><br><br>
