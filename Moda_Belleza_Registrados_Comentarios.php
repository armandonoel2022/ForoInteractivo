...
$temasPermitidos = ['Tendencias_oda', 'Cuidado_de_la_piel', 'Estilismo_y_maquillaje', 'Moda_sostenible'];
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        <option value="Tendencias_oda">Tendencias de moda</option>
                        <option value="Cuidado_de_la_piel">Cuidado de la piel</option>
                        <option value="Estilismo_y_maquillaje">Estilismo y maquillaje</option>
                        <option value="Moda_sostenible">Moda sostenible</option>
                    </select><br><br>
