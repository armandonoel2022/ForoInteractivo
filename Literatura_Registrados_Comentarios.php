<?php
// Literatura_Registrados_Comentarios.php
session_start();
...
<head>
    ...
    <title>Literatura - Comentarios</title>
        ...
        <aside class="sidebar">
            ...
            <form action="guardar_comentario.php" method="POST">
                ...
                <select id="tema" name="tema">
                    <option value="Reseñas de libros">Reseñas de libros</option>
                    <option value="Novedades editoriales">Novedades editoriales</option>
                    <option value="Entrevistas a autores">Entrevistas a autores</option>
