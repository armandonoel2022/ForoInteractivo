<?php
// Cine_Series_Registrados_Comentarios.php
session_start();
...
$temasPermitidos = ['Criticas_Peliculas', 'Estrenos_Cine', 'Series_TV', 'Documentales'];
...
<head>
    ...
    <title>Cine y Series - Comentarios</title>
...
<body>
    ...
    <div class="forum-content">
        <h2>Cine y Series - Comentarios</h2>
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        <option value="Criticas_Peliculas">Críticas de películas</option>
                        <option value="Estrenos_Cine">Estrenos de cine</option>
                        <option value="Series_TV">Series de TV</option>
