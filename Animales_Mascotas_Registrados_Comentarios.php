        ...
        <div class="content-wrapper">
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <option value="Lenguajes">Cuidado de mascotas</option>
                    <option value="DesarrolloWeb">Entrenamiento</option>
                    <option value="DesarrolloApps">Salud animal</option>
                    <option value="ProyectosOpenSource">Especies exóticas</option>
                </select><br><br>
