<?php
// Animales_Mascotas_Registrados_Comentarios.php
session_start();
...
$temasPermitidos = ['Cuidado_de_mascotas', 'Entrenamiento', 'Salud_animal', 'Especies_exoticas'];
...
<head>
    ...
    <title>Animales y Mascotas - Comentarios</title>
...
<body>
    ...
    <div class="forum-content">
        <h2>Animales y Mascotas - Comentarios</h2>
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        ...
                        <option value="Salud_animal">Salud animal</option>
                        <option value="Especies_exoticas">Especies exóticas</option>
                    </select><br><br>
