        ...
        <div class="content-wrapper">
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <option value="Lenguajes">Metodologías de enseñanza</option>
                    <option value="DesarrolloWeb">Recursos educativos</option>
                    <option value="DesarrolloApps">Tecnología en la educación</option>
                    <option value="ProyectosOpenSource">Políticas educativas</option>
                </select><br><br>
