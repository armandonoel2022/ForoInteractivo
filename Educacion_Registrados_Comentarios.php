<?php
// Educacion_Registrados_Comentarios.php
session_start();
        ...
        <aside class="sidebar">
            ...
            <form action="guardar_comentario.php" method="POST">
                ...
                <select id="tema" name="tema">
                    <option value="Metodologías de enseñanza">Metodologías de enseñanza</option>
                    <option value="Recursos educativos">Recursos educativos</option>
                    <option value="Tecnología en la educación">Tecnología en la educación</option>
