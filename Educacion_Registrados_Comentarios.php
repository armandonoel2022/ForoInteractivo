<?php
// Educación_Registrados_Comentarios.php
session_start();
...
// Filtrar los comentarios de la sección de educación
$temasPermitidos = ['Metodologias', 'Recursos_educativos', 'Tecnologia_en_la_educación', 'Políticas_educativas'];
...
<head>
    ...
    <title>Educación - Comentarios</title>
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        <option value="Metodologias">Metodologías de enseñanza</option>
                        <option value="Recursos_educativos">Recursos educativos</option>
                        <option value="Tecnologia_en_la_educación">Tecnología en la educación</option>
                        <option value="Políticas_educativas">Políticas educativas</option>
                    </select><br><br>
