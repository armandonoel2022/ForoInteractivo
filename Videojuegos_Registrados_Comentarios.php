        ...
        <aside class="sidebar">
            ...
            <form action="guardar_comentario.php" method="POST">
                ...
                <select id="tema" name="tema">
                    <option value="Noticias">Noticias de videojuegos</option>
                    <option value="Reviews">Reviews y análisis de juegos</option>
                    <option value="Guias">Guías y tutoriales</option>
                    <option value="Comunidades">Comunidades de jugadores</option>
                </select><br><br>
