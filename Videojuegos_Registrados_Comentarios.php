<?php
// Videojuegos_Registrados_Comentarios.php
session_start();
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        <option value="Noticias_Videojuegos">Noticias de videojuegos</option>
                        <option value="Analisis_Videojuegos">Reviews y Análisis de juegos</option>
                        <option value="Tutoriales_juegos">Guías y tutoriales</option>
                        <option value="Comunicades_Videojuegos">Comunidades de jugadores</option>
                    </select><br><br>
