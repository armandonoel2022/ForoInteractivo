...
<head>
    ...
    <title>Programación y Desarrollo - Comentarios</title>
        ...
        <div class="content-wrapper">
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <option value="Lenguajes">Noticias de videojuegos</option>
                    <option value="DesarrolloWeb">Reviews y Análisis de juegos</option>
                    <option value="DesarrolloApps">Guías y tutoriales</option>
                    <option value="ProyectosOpenSource">Comunidades de jugadores</option>
                </select><br><br>
