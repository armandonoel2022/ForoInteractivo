...
<head>
    ...
    <title>Emprendimiento y Negocios</title>
    ...
    <div class="forum-content">
        ...
        <section class="main-content">
            ...
            <div class="comentarios">
                ...
                $sql = "SELECT tema, comentario, created_at FROM comentarios WHERE tema='Emprendimiento y Negocios' ORDER BY created_at DESC LIMIT 5";
