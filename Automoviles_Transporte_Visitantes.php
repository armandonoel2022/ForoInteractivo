...
<head>
    ...
    <title>Automóviles y Transporte</title>
...
<body>
    ...
    <div class="forum-content">
        <h2>Automóviles y Transporte</h2>
        ...
        <section class="main-content">
            ...
            <div class="comentarios">
                ...
                $sql = "SELECT tema, comentario, created_at FROM comentarios WHERE tema='Automóviles y Transporte' ORDER BY created_at DESC LIMIT 5";
