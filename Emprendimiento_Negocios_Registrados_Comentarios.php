        ...
        <div class="content-wrapper">
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <option value="Lenguajes">Ideas de negocio</option>
                    <option value="DesarrolloWeb">Casos de éxito</option>
                    <option value="DesarrolloApps">Marketing y ventas</option>
                    <option value="ProyectosOpenSource">Financiación y recursos</option>
                </select><br><br>
