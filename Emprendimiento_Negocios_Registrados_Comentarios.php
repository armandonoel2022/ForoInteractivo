<?php
// Emprendimiento_Negocios_Registrados_Comentarios.php
session_start();
...
// Filtrar los comentarios de la sección de emprendimiento y negocios
$temasPermitidos = ['Ideas_de_negocio', 'Casos_de_exito', 'Marketing_ventas', 'Financiacion_recursos'];
...
<head>
    ...
    <title>Emprendimiento y Negocios - Comentarios</title>
...
<body>
    ...
    <div class="forum-content">
        <h2>Emprendimiento y Negocios - Comentarios</h2>
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        <option value="Ideas_de_negocio">Ideas de negocio</option>
                        <option value="Casos_de_exito">Casos de éxito</option>
                        <option value="Marketing_ventas">Marketing y ventas</option>
                        <option value="Financiacion_recursos">Financiación y recursos</option>
                    </select><br><br>
