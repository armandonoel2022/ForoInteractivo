<?php
// Ciencias_Ocultas_Misterios_Registrados_Comentarios.php
session_start();
...
$temasPermitidos = ['Ufologia', 'Criptozoologia', 'Paranormal', 'Misterios_historicos'];
...
<head>
    ...
    <title>Ciencias Ocultas y Misterios - Comentarios</title>
...
<body>
    ...
    <div class="forum-content">
        <h2>Ciencias Ocultas y Misterios - Comentarios</h2>
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        <option value="Ufologia">Ufología</option>
                        <option value="Criptozoologia">Criptozoología</option>
                        <option value="Paranormal">Paranormal</option>
                        <option value="Misterios_historicos">Misterios históricos</option>
                    </select><br><br>
