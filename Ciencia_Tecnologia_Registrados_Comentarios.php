<?php
// Ciencia_Tecnologia_Registrados_Comentarios.php
session_start();
...
<body>
    ...
    <div class="forum-content">
        <h2>Ciencia y Tecnología - Comentarios</h2>
        ...
        <aside class="sidebar">
            ...
            <form action="guardar_comentario.php" method="POST">
                ...
                <select id="tema" name="tema">
                    <option value="Últimos avances">Últimos avances</option>
                    <option value="Innovaciones tecnológicas">Innovaciones tecnológicas</option>
                    <option value="Ciencia aplicada">Ciencia aplicada</option>
                    <option value="Proyectos científicos">Proyectos científicos</option>
                </select><br><br>
