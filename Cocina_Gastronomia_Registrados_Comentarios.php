<?php
// Cocina_Gastronomia_Registrados_Comentarios.php
session_start();
...
// Filtrar los comentarios de la sección de cocina y gastronomía
$temasPermitidos = ['Recetas', 'Cultura_gastronomica', 'Nutricion_salud', 'Tecnicas_culinarias'];
...
<head>
    ...
    <title>Cocina y Gastronomía - Comentarios</title>
...
<body>
    ...
    <div class="forum-content">
        <h2>Cocina y Gastronomía - Comentarios</h2>
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        ...
                        <option value="Cultura_gastronomica">Cultura gastronómica</option>
                        <option value="Nutricion_salud">Nutrición y salud</option>
                        <option value="Tecnicas_culinarias">Técnicas culinarias</option>
                    </select><br><br>
