        ...
        <div class="content-wrapper">
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <option value="Lenguajes">Recetas</option>
                    <option value="DesarrolloWeb">Cultura gastronómica</option>
                    <option value="DesarrolloApps">Nutrición y salud</option>
                    <option value="ProyectosOpenSource">Técnicas culinarias</option>
                </select><br><br>
