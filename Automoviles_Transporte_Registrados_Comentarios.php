        ...
        <div class="content-wrapper">
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <option value="Lenguajes">Nuevos modelos de automóviles</option>
                    <option value="DesarrolloWeb">Transporte público</option>
                    <option value="DesarrolloApps">Energías alternativas</option>
                    <option value="ProyectosOpenSource">Mantenimiento y reparaciones</option>
                </select><br><br>
