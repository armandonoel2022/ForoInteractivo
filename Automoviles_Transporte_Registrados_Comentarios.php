<?php
// Automóviles_Transporte_Registrados_Comentarios.php
session_start();
...
$temasPermitidos = ['Nuevos_modelos_de_automóviles', 'Transporte_publico', 'Energias_alternativas', 'Mantenimiento_y_reparaciones'];
...
<head>
    ...
    <title>Automóviles y Transporte - Comentarios</title>
...
<body>
    ...
    <div class="forum-content">
        <h2>Automóviles y Transporte - Comentarios</h2>
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        <option value="Nuevos_modelos_de_automóviles">Nuevos modelos de automóviles</option>
                        <option value="Transporte_publico">Transporte público</option>
                        <option value="Energias_alternativas">Energías alternativas</option>
                        <option value="Mantenimiento_y_reparaciones">Mantenimiento y reparaciones</option>
                    </select><br><br>
