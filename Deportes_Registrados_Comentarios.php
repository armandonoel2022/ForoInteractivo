...
// Filtrar los comentarios de la sección de deportes
$temasPermitidos = ['Noticias_Deportivas', 'Resultados_Partidos', 'Analisis_Jugadores', 'Eventos_Deportivos'];
...
<body>
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        <option value="Noticias_Deportivas">Noticias Deportivas</option>
                        <option value="Resultados_Partidos">Resultados de partidos</option>
                        <option value="Analisis_Jugadores">Análisis de jugadores</option>
                        <option value="Eventos_Deportivos">Eventos deportivos</option>
                    </select><br><br>
    ...
    function enviarComentario() {
        ...
        .then(data => {
            mostrarPopup();
            setTimeout(function() {
                location.reload(); // Recargar la página después de mostrar el popup
