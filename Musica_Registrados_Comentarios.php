<?php
// Musica_Registrados_Comentarios.php
session_start();
        ...
        <aside class="sidebar">
            ...
            <form action="guardar_comentario.php" method="POST">
                ...
                <select id="tema" name="tema">
                    ...
                    <option value="Análisis de álbumes">Análisis de álbumes</option>
                    <option value="Música independiente">Música independiente</option>
                </select><br><br>
