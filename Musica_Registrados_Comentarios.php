<?php
// Música_Registrados_Comentarios.php
session_start();
...
$temasPermitidos = ['Nuevos_Lanzamientos', 'Conciertos', 'Albumes', 'Musica_Independiente'];
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        ...
                        <option value="Conciertos">Conciertos y festivales</option>
                        <option value="Albumes">Análisis de álbumes</option>
                        <option value="Musica_Independiente">Música independiente</option>
                    </select><br><br>
