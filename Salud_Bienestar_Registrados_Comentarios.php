<?php
// Salud_y_Bienestar_Registrados_Comentarios.php
session_start();
...
// Filtrar los comentarios de la sección de salud y bienestar
$temasPermitidos = ['Nutricion', 'Ejercicio_fisico', 'Salud_mental', 'tratamientos'];
...
<head>
    ...
    <title>Salud y Bienestar - Comentarios</title>
...
<body>
    ...
    <div class="forum-content">
        <h2>Salud y Bienestar - Comentarios</h2>
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        ...
                        <option value="Ejercicio_fisico">Ejercicio físico</option>
                        <option value="Salud_mental">Salud mental</option>
                        <option value="tratamientos">Medicina y tratamientos</option>
                    </select><br><br>
