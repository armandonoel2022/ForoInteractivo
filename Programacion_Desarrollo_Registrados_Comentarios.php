...
<body>
    ...
    <div class="forum-content">
        <h2>Programación y Desarrollo - Comentarios</h2>
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        <option value="Lenguajes">Lenguajes de programación</option>
                        <option value="DesarrolloWeb">Desarrollo web</option>
                        <option value="DesarrolloApps">Desarrollo de aplicaciones móviles</option>
                        <option value="ProyectosOpenSource">Proyectos open source</option>
                    </select><br><br>
