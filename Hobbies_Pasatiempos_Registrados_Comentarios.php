<?php
// Hobbies_y_Pasatiempos_Registrados_Comentarios.php
session_start();
...
// Filtrar los comentarios de la sección de hobbies y pasatiempos
$temasPermitidos = ['Manualidades', 'actividades_al_aire_libre', 'puzzles', 'Coleccionismo'];
...
<head>
    ...
    <title>Hobbies y Pasatiempos - Comentarios</title>
...
<body>
    ...
    <div class="forum-content">
        <h2>Hobbies y Pasatiempos - Comentarios</h2>
            ...
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <select id="tema" name="tema">
                        ...
                        <option value="actividades_al_aire_libre">Deportes y actividades al aire libre</option>
                        <option value="puzzles">Juegos de mesa y puzzles</option>
