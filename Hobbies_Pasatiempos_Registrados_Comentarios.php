        ...
        <div class="content-wrapper">
            <aside class="comment-form">
                ...
                <form id="comentarioForm">
                    ...
                    <option value="Lenguajes">Manualidades</option>
                    <option value="DesarrolloWeb">Deportes y actividades al aire libre</option>
                    <option value="DesarrolloApps">Juegos de mesa y puzzles</option>
                    <option value="ProyectosOpenSource">Coleccionismo</option>
                </select><br><br>
